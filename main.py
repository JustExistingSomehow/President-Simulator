...
# Define events
events = [
    {"title": "Economic boom!", "description": "The economy is thriving.", "choices": [{"text": "Celebrate", "approval": 5, "economy": 10}, {"text": "Invest", "funds": -5, "economy": 15}]},
    {"title": "Military conflict!", "description": "A conflict has arisen.", "choices": [{"text": "Deploy troops", "approval": -10, "military": -5}, {"text": "Negotiate", "approval": 10, "diplomacy": 10}]},
    {"title": "Disease outbreak!", "description": "A disease is spreading.", "choices": [{"text": "Quarantine", "approval": -5, "health": 5}, {"text": "Research cure", "health": 10, "funds": -10}]},
    {"title": "Education crisis!", "description": "A lack of faculty is damaging the education system.", "choices": [{"text": "Increase funding", "education": 20, "funds": -10}, {"text": "Ignore", "education": -10}]},
    {"title": "Environmental disaster!", "description": "An environmental disaster has occurred.", "choices": [{"text": "Clean up", "environment": 10, "approval": 10, "funds": -10}, {"text": "Ignore", "environment": -10}]},
    {"title": "Terrorist attack!", "description": "A terrorist attack has taken place.", "choices": [{"text": "Increase security", "security": 10, "approval": -5}, {"text": "Address root causes", "military": -5 ,"funding": -5,"security": 15, "approval": 5}]},
    {"title": "Scandal!", "description": "A scandal has been uncovered.", "choices": [{"text": "Address publicly", "approval": -5}, {"text": "Ignore", "approval": -10}]},
    {"title": "Natural disaster!", "description": "A natural disaster has struck.", "choices": [{"text": "Provide aid", "approval": 10, "funds": -10, "environment": -5}, {"text": "Ignore", "approval": -10, "environment": -10}]},
    {"title": "Technological breakthrough!", "description": "A new technology has been developed.", "choices": [{"text": "Invest in research", "economy": 10, "approval": 5, "education": 5, "funds": -5}, {"text": "Sell patents", "economy": 15, "funds": 10}]},
    {"title": "Healthcare crisis!", "description": "The healthcare system experiencing a shortage of nurses.", "choices": [{"text": "Increase funding", "approval": 10, "funds": -10, "health": 10}, {"text": "Ignore", "approval": -5, "health": -10}]},
    {"title": "Education reform!", "description": "Reforms in education are proposed.", "choices": [{"text": "Implement changes", "approval": 10, "funds": -10, "education": 10}, {"text": "Delay", "approval": -5, "education": -5}]},
